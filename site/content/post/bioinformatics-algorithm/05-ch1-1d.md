...
*Fig 1. (A) Bacterial Replication Initiation, (B) Eukaryotic Replication Initiation - [Wikipedia](https://en.wikipedia.org/wiki/Origin_of_replication)*
...
1. 가져온 유전체의 부분 문자열과 주어진 pattern을 비교
1. 서로 같으면 그 위치를 저장 후 순회가 끝나면 모든 위치를 반환
